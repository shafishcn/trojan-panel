...
def build_clash_subscription_yaml(
    ...
    lines.extend(
        [
            ...
            "    nameserver-policy: { 'planb.mojcn.com,m.cnmjin.net': ['https://api.edgequery.cc:40443/dns-query', 'https://39.173.146.159:8443/dns-query', 'https://36.150.95.34:8443/dns-query', 'https://api.edgequery.net:40443/dns-query'] }",
            "    nameserver: ['https://223.5.5.5/dns-query', 'https://doh.pub/dns-query', 119.29.29.29, 223.5.5.5, 'tls://223.5.5.5:853', 'tls://223.6.6.6:853']",
            "    fallback: ['https://223.5.5.5/dns-query', 'https://doh.pub/dns-query']",
